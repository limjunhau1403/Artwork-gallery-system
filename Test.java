...
public class Test {
	public static void main (String [] args)throws IOException, FileNotFoundException
	{
				...
				case 2:
					{
						...
						for(int i =0; i < customer.size(); i ++)
						{
							if (customer.get(i).getId().equals(customerId))
							{
								...
								}while(customer.get(i).getId().equals(customerId));
							}
						}
						...
						for(int i =0; i < artist.size(); i ++)
						{
							if (artist.get(i).getId().equals(customerId))
							{
								do {
									...
									System.out.print("\n Customer ID: ");
									customerId = sc.nextLine();
								}while(artist.get(i).getId().equals(customerId));
							}
							}e = true;
						}while( e == false);
						...
						for(int i =0; i < customer.size(); i ++)
						{
							if (customer.get(i).getHpnumber().equals(hpnumber))
							{
								do {
									...
									hpnumber= sc.nextLine();
									numrr = Integer.parseInt(hpnumber);
								}while(customer.get(i).getHpnumber().equals(hpnumber));
							}
						}
						}
						catch(NumberFormatException exception)
						 ...
						 case 1:{
							 ...
							 System.out.print("Please enter the new customer ID: ");
								...
								boolean valid = false;
							 	...
							 	do { 
							 	for(int i=0;i<artist.size();i++)
					        	{if(artist.get(i).getId().contentEquals(changedCustomerID))
					        	{
					        		{do {
					        		System.out.print("ID already exist !!!");
					        		System.out.print("\nPlease enter the new customer ID: ");
					        		changedCustomerID = sc.nextLine();
					        	}while(artist.get(i).getId().contentEquals(changedCustomerID));
					        	}
								}
					        	}
							 	...
							 	for(int i=0;i<customer.size();i++)
					        	{
							 		if(customer.get(i).getId().contentEquals(changedCustomerID))
					        	{
					        		{do 
					        		{
					        		System.out.print("ID already exist !!!");
					        		System.out.print("\nPlease enter the new customer ID: ");
					        		changedCustomerID = sc.nextLine();
					        	}while(customer.get(i).getId().contentEquals(changedCustomerID));
					        	}
								}
					        	}
							 	valid = true;
							 ...
							 try {
								...
								int a = Integer.parseInt(changedPhoneNumber);
								 ...
								 boolean valid = false;
								 	...
								 	do {
								 	for(int i=0;i<customer.size();i++)
						        	{if(customer.get(i).getHpnumber().contentEquals(changedPhoneNumber))
						        	{
						        		{do {
						        		System.out.print("Phone number already exist in customer !!!");
						        		System.out.print("\nPlease enter the new phone number: ");
						        		changedPhoneNumber = sc.nextLine();
										a = Integer.parseInt(changedPhoneNumber);
						        	}while(customer.get(i).getHpnumber().contentEquals(changedPhoneNumber));
						        	}
									}
						        	}
								 	valid = true;
				...
				case 2:{
					artistChoice =0;
				        ...
				        System.out.print("Artist ID: ");
				        	...
				        	for(int i =0; i < artist.size(); i ++)
							{
								if (artist.get(i).getId().equals(artistID))
								{
									...
									}while(artist.get(i).getId().equals(artistID));
								}
							}
							...
							for(int i =0; i < customer.size(); i ++)
							{
								if (customer.get(i).getId().equals(artistID))
								{
									do {
										...
										System.out.print("\n Artist ID: ");
										artistID = sc.nextLine();
									}while(customer.get(i).getId().equals(artistID));
								}
							}
				        ...
				        System.out.print("ArtistPhone Number: ");
				        	 ...
				        	 for(int i=0;i<artist.size();i++)
					        	{if(artist.get(i).getHpnumber().contentEquals(phoneNumber))
					        	{
					        		{do {
					        		System.out.print("Number already exist !!!");
					        		System.out.print("\nArtist Phone Number: ");
					        		phoneNumber=sc1.nextLine();
					        		numrr=Integer.parseInt(phoneNumber);
					        	}while(artist.get(i).getHpnumber().contentEquals(phoneNumber));
					        	}
					        	}
					        	}
				...
				case 5:{
					...
					System.out.print("\nPlease enter the artist ID for the artist information you want modify: ");
					 ...
					 case 1:{
						 ...
						 do { 
							 	for(int i=0;i<artist.size();i++)
					        	{if(artist.get(i).getId().contentEquals(changedArtistID))
					        	{
					        		{do {
					        		System.out.print("ID already exist !!!");
					        		System.out.print("\nPlease enter the new customer ID: ");
					        		changedArtistID = sc4.nextLine();
					        	}while(artist.get(i).getId().contentEquals(changedArtistID));
					        	}
								}
					        	}
							 	
							 	for(int i=0;i<customer.size();i++)
					        	{if(customer.get(i).getId().contentEquals(changedArtistID))
					        	{
					        		{do {
					        		System.out.print("ID already exist !!!");
					        		System.out.print("\nPlease enter the new customer ID: ");
					        		changedArtistID = sc4.nextLine();
					        	}while(customer.get(i).getId().contentEquals(changedArtistID));
					        	}
								}
					        	}
							 	valid = true;
					 ...
					 case 4:{
						 ...
						 try {
							...
							boolean valid = false;
							 ...
							 for (int i = 0; i < artist.size(); i++)
								{
								 if(artist.get(i).getHpnumber().contentEquals(changedPhoneNumber))
								 {
									 do {
										 
									 System.out.print("Phone number already exist in artist !!!");
										 System.out.print("Please enter the new phone number: ");
										 	changedPhoneNumber = sc4.nextLine();
										 	a = Integer.parseInt(changedPhoneNumber);
									 }while(artist.get(i).getHpnumber().contentEquals(changedPhoneNumber));
								 }
	    		...
	    		for(int i =0; i < artwork.size(); i ++)
				{
					if (artwork.get(i).getArtID().equals(artID))
					{
						do {
							...
							System.out.print("\n Art ID: ");
							artID = sc.nextLine();
						}while(artwork.get(i).getArtID().equals(artID));
					}
				}
			...
			for (int i = 0; i < count; i++)
			 ...
			 case 4:{
						...
						if (changedAvailability.equals( "No") && artwork.get(num).getAvailability().equals("Yes"))
						{
							...
							String customerName = sc4.nextLine();
							int count2 = customer.size();
							do {
							...
							for(i= 0 ; i<count2; i++)
							{
								if (customer.get(i).getName().equals(customerName))
								{
							        ...
							        catch(NumberFormatException exception)
									{
										...
										list3[num].setCustomerName(customerName);
		...
		System.out.print("Thank you for using UX Gallery System!!");
	}
}
